        ...
        <main>
            <body>
                ...
                <div style={{ display: 'flex',flexWrap:"wrap", height: '50vh',}}>
                    <div style={{display:"flex",justifyContent:"center",flexDirection:"column",alignContent:"center",width:"70%",height:"100%", marginLeft:"4%"}}>
                        <h2 style={{textAlign:"center"}}>¿Quien Somos?</h2>
                        <text style={{textAlign:"center", margin:"2%",backgroundColor: 'rgba(51, 51, 51, 0.5)', borderRadius: 10, fontSize:"25"}}>
